...
import upayan from "../../media/upayan.png";
...
export const RouterHead = component$(() => {
  ...
  // Format the title
  const formattedTitle = head.title ? `Upayan - ${head.title}` : "Upayan";

  // Set og:image, use default image if not defined
  const ogImage = head.meta.find((m) => m.property === "og:image")?.content || upayan;
