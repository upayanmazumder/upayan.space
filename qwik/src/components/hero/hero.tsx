        ...
        {/*Discord Button*/}
          <button
            ...
            onClick$={async () => {
              ...
              // Open website in new tab after animation
              setTimeout(() => {
                window.open("https://discord.com/users/1240025366853193758", "_blank");
              }, 990); // Adjust the delay time as needed
            }}
          >
            Discord
        ...
        {/*Gravatar Button*/}
          <button
            ...
            onClick$={async () => {
              ...
              // Open website in new tab after animation
              setTimeout(() => {
                window.open("https://gravatar.com/upayanmazumder", "_blank");
              }, 990); // Adjust the delay time as needed
            }}
          >
            Gravatar
